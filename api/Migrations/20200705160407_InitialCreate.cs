        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PagamentoDebito = table.Column<string>(nullable: true),
                    PagamentoCredito = table.Column<string>(nullable: true),
                    PagamentoEspecie = table.Column<string>(nullable: true),
                    PagamentoFinanciamento = table.Column<string>(nullable: true),
                    PagamentoOutros = table.Column<string>(nullable: true),
                    ...
                    caminhao = table.Column<string>(nullable: true),
